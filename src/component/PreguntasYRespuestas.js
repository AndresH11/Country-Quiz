...
const PreguntasYRespuestas = ({ preRe, validacionRespuesta, nextQuestion, iconoChechOX }) => {
  ...
  while (bandera) {
    ...
    return(
        <>
          ...
          <Preguntas pregunta={preRe.pregunta} linkSrc={preRe.flag} />
          
          { posicionAleatoria.map( opcion => (

            <ContenedorRespuestas onClick={ validacionRespuesta } id= { idDinamico++ } >
